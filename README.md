# 📋 MÔ TẢ DỰ ÁN - NỀN TẢNG GIAO DỊCH BẤT ĐỘNG SẢN
...
Nền tảng **Giao Dịch Bất Động Sản** là hệ thống trung gian kết nối **Công ty Bất Động Sản** với **Người có nhu cầu mua / bán BĐS**. Hệ thống cho phép các Công ty BĐS đăng tin rao bán tài sản, quản lý danh sách tài sản và theo dõi toàn bộ quá trình tư vấn khách hàng từ lúc khách để lại thông tin đến khi hoàn thành giao dịch.
...
| Section | Nội dung |
|---|---|
| Hero | Slogan, mô tả ngắn, CTA "Liên hệ tư vấn" |
...
| Blog | Bài viết thị trường BĐS (SEO) |
...
**Hiển thị:**
- Header: Logo + Thanh tìm kiếm nhanh + Nút "Đăng nhập"
...
| # | Tên màn | Mô tả ngắn |
|---|---|---|
| M01 | Trang Chủ | Danh sách tin đăng + bộ lọc nhanh |
